...
//
//        beforeEach(function() {
//            Injector = window.adron.Injector;
//        });
//
//        it('should be attached to window.adron', function() {
//            expect(Injector).toEqual(window.adron.Injector);
//        });
//
...
//                expect(function(){
//                    injector.inject(fn)
//                }).toThrowError("adron.di.Injector: 'thingThatDoesntExistOnSource' does not exist in the source map!");
//            });
//
